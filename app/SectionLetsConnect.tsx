  ...
  const socialMediaLinks = [
    {
      ...
      onClick: () =>
        window.open(
          "https://www.linkedin.com/in/khursheed-ahmed-f202265038/",
          "_blank"
        ),
    },
    {
      ...
      tabIndex: 0,
      onClick: () =>
        window.open("https://www.instagram.com/khur5heed.ahmed/", "_blank"),
    },
    {
      initial: { y: -50, opacity: 0 },
      animate: inView ? { y: 0, opacity: 1 } : {},
      ...
      tabIndex: 0,
      onClick: () =>
        window.open("https://github.com/khursheedahmedd", "_blank"),
    },
    {
      initial: { y: -50, opacity: 0 },
      animate: inView ? { y: 0, opacity: 1 } : {},
        ...
        <div className="relative flex flex-col items-center justify-center">
          ...
          <div className="flex flex-row flex-wrap items-center justify-center gap-3 mt-4 lg:hidden">
            ...
            <AnimatedImage
              ...
              tabIndex={0}
              onClick={() =>
                window.open("https://instagram.com/khur5heed.ahmed", "_blank")
              }
            />
            <AnimatedImage
              initial={{ y: -50, opacity: 0 }}
